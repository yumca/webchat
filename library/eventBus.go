...
//copy by  github.com/asaskevich/EventBus
//update:  Publish add result
import (
	"fmt"
	"reflect"
	"sync"
...
type BusPublisher interface {
	Publish(topic string, args ...interface{}) []reflect.Value
}
...
func (bus *EventBus) Publish(topic string, args ...interface{}) []reflect.Value {
